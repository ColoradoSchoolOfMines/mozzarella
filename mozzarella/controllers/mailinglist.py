...
from mozzarella.model import DBSession, MailMessage
...
class MailingListController(BaseController):
    @expose('mozzarella.templates.mailinglist')
    def index(self):
    ...
    @expose('mozzarella.templates.message')
    ...
    @expose('mozzarella.templates.archives')
